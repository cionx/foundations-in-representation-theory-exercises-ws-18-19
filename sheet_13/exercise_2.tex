...
\[
  ...
  0 \,;
\]
we also think about~$\Rational/\Integer$ as a subgroup of the circle group~$\mathbb{S}^1$ via the exponential map, and find for the subgroup~$\mu_n \subseteq \mathbb{S}^1$ of~\dash{$n$}{th} root of unity that
\[
  \Hom_\Integer(\Integer/n, \Rational/\Integer)
  =
