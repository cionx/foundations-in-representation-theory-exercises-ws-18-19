...
We start by showing that every free~{\module{$A$}}~$F$ is projective:
Let~$f \colon M \to N$ be an epimorphism of~{\modules{$A$}} and let~$g \colon F \to N$ be any homomorphism of~{\modules{$A$}}.
...
\]
commutes.
This shows that~$F$ is projective.
