...
\]
commutes.
By applying the \dash{right}{hand} {\pb} square to the morphisms~$\alpha \colon Z \to X$ and~$h \circ \delta \colon Z \to Y'$, we find that there exist a unique morphism~$\beta \colon Z \to X'$ with~$g' \circ \beta = \alpha$ and~$f' \circ \beta = h \circ \delta$, i.e.\ such that the diagram
\[
  \begin{tikzcd}
      Z
