...
The map~$\mu \in \Maps(A \times V, V)$ is an~{\Amod} structure if and only if the following axioms are satisfied for all~$a, a_1, a_2 \in A$, all~$\lambda \in k$ and all~$m, m_1, m_2 \in M$:
